...
title: 翻译集
uuid: ba66a61-5520-452a-bc0 b-e4 f6 b57 f1744
...
可为除Storify之外的所有应用程序指定翻译设置。有关可以本地化的字段的详细信息，请参阅 [本地化字符串](/help/using/c-settings-other/c-translation-sets/c-localize-strings.md)。
...
* API转换集覆盖任何级别的任何翻译集(应用程序、网络和站点)
* 应用程序翻译集覆盖网络级别和站点级翻译集。
* 站点级翻译集覆盖网络级翻译集。

## 审阅文本字符串 {#c-review-text-strings}
...
|---|---|---|
| *评论页脚* |  |  |
|  | wasreviewHelpful | [有帮助？](https://d.pr/i/Q0mA) |
...
|  | 标记确认消息 | 将%s的审阅标记为%s？ |
| *提及模式* |  |  |
|  | mentionDefaultText | 我在Livefyre审阅中提及了您！ |
| *共享模式* |  |  |
|  | ShareTitle | 共享审阅 |
...
|---|---|---|
| 错误 |  |  |
|  | ErroralreadyPublished | 您只能发布一个审阅。 |
...
|  | 问题解释 | 您现在可以直接在句子、段落、图像和引号上阅读和编写注释。<br>突出显示文本并单击图标，或单击每个段落末尾的图标。 |
